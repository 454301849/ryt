...
<div class="pg-form"> 
    ...
    <?php if($userinfo['headimgurl'] != ''): ?><img id="mypic" src="<?php echo ($user_info["headimgurl"]); ?>" alt="头像"  width="100" height="100"/>
        <?php else: ?>
        <img id="mypic" src="/Public/images/userhead.jpg" alt="头像"  width="100" height="100"/><?php endif; ?>
    ...
    <br />
    <input id="headimgurl_" type="hidden" class="form-control"   value="<?php echo ($user_info["headimgurl"]); ?>">
    <label class="control-label">真实姓名</label>
    <input id="username_" type="text" class="form-control" placeholder="真实姓名" value="<?php echo ($user_info["truename"]); ?>">
    <label class="control-label">身份证</label>
    <input id="idcard_" type="text" class="form-control" placeholder="身份证" value="<?php echo ($user_info["idcard"]); ?>">
    <label class="control-label">开户银行</label>
    <select id="bankid_" class="form-control"></select>
    <label class="control-label">开户卡号</label>
    <input id="bankno_" type="text" class="form-control" placeholder="开户卡号" value="<?php echo ($user_info["bankno"]); ?>">
    <label class="control-label">开户地址</label>
    <input id="bankname_" type="text" class="form-control" placeholder="开户地址" value="<?php echo ($user_info["bankname"]); ?>">
    <label class="control-label">开户姓名</label>
    <input id="bankuser_" type="text" class="form-control" placeholder="开户姓名" value="<?php echo ($user_info["bankuser"]); ?>">
    <label class="control-label">手机</label>
    <input id="moblie_" type="text" class="form-control" placeholder="手机" value="<?php echo ($user_info["moblie"]); ?>">
    <label class="control-label">邮箱</label>
    <input id="email_" type="text" class="form-control" placeholder="邮箱" value="<?php echo ($user_info["email"]); ?>">
    <label class="control-label">邮编</label>
    <input id="zipcode_" type="text" class="form-control" placeholder="邮编" value="<?php echo ($user_info["zipcode"]); ?>">
    <label class="control-label">地址</label>
    <input id="address_" type="text" class="form-control" placeholder="地址" value="<?php echo ($user_info["address"]); ?>">
