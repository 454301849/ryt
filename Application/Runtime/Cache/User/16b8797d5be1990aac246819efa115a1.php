...
<div class="pg-form">
    ...
    <input id="number_" type="text" class="form-control" placeholder="转换金额" style="width:300px;">
    <label class="control-label">二级密码</label>
    <input id="safeword_" type="password" class="form-control" placeholder="二级密码"  style="width:300px;">

    <div class="btn-group btn-group-justified" role="group" aria-label="...">
        <div class="btn-group" role="group">
            <a id="btn_enter_" data-transition="pop" class="btn btn-default btn-danger"  style="width:100px;">确认转换</a>
			<a href="/User/Deal/convert" class="btn btn-default"  style="width:100px;float:left; margin-left:50px; border-ridius:3px;"  >返回</a>
        </div>
        <div class="btn-group" role="group">
