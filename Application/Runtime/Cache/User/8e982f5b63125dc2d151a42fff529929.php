...
<body>
<!--标题样式-->
<div class="mn-content ui-page ui-page-theme-a ui-page-active" data-role="page" data-url="/User/Deal/recordlists" data-external-page="true" tabindex="0" style="min-height: 635.2px;">
<table class="table table-hover table-condensed">
    ...
    <tr>
        ...
        <?php if(is_array($info)): $kk = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($kk % 2 );++$kk;?><tr>
            ...
            <td>
                <a href="/User/Deal/recorddetail?id=<?php echo ($vv["id"]); ?>" class="btn btn-danger btn-xs">记录详情</a>
            </td>
