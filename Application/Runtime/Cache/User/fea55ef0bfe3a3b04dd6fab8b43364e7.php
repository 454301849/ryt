...
<div class="btn-group btn-group-justified" role="group" aria-label="...">
    <div class="btn-group" role="group">
        <a href="/User/Deal/lists" class="btn btn-default" style="width:200px; ">列表</a>
		<a href="/User/Deal/classify" class="btn btn-danger"  style="width:200px;  float:left; margin-left:50px;">筛选</a>
    </div>
    <div class="btn-group" role="group">
...
<div id="type_group_3DE195FA4A9E9D74E39339A068D6D62E" class="list-group" style="margin-top:12px;">
    <a onclick="pck.setType(this, -1)" class="list-group-item" style="width:500px;"><span class="glyphicon glyphicon-th-list"></span>不限分类</a>
        <a onclick="pck.setType(this, 5)" class="list-group-item"style="width:500px;"><span class="glyphicon glyphicon-triangle-right"></span>分享奖</a>
        <a onclick="pck.setType(this, 6)" class="list-group-item" style="width:500px;"><span class="glyphicon glyphicon-triangle-right"></span>见点奖</a>
        <a onclick="pck.setType(this, 3)" class="list-group-item"style="width:500px;"><span class="glyphicon glyphicon-triangle-right"></span>领导奖</a>
		<a onclick="pck.setType(this, 7)" class="list-group-item"style="width:500px;"><span class="glyphicon glyphicon-triangle-right"></span>区域管理奖</a>
		 <a onclick="pck.setType(this, 8)" class="list-group-item" style="width:500px;"><span class="glyphicon glyphicon-triangle-right"></span>推荐奖</a>
...
<div class="btn-group btn-group-justified" role="group" aria-label="...">
    <div class="btn-group" role="group">
        <a id="btn_enter" class="btn btn-default btn-danger" style="width:200px;">确定筛选</a>
		 <a id="btn_clear" class="btn btn-default"  style="width:200px; float:left; margin-left:50px;">清空</a>
    </div>
