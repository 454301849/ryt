      ...
      <div class="bd">
        <div class="weui_panel weui_panel_access" style="background:#;">
          ...
          <div class="pg-form">
			    ...
			    <input id="name_" type="text" class="form-control" placeholder="收货人" value="<?php echo ($address_info["username"]); ?>">
			    <label class="control-label">邮箱</label>
			    <input id="email_" type="text" class="form-control" placeholder="邮箱" value="<?php echo ($address_info["email"]); ?>">
			    <label class="control-label">手机</label>
			    <input id="moblie_" type="text" class="form-control" placeholder="手机" value="<?php echo ($address_info["telphone"]); ?>">
			    <label class="control-label">地址</label>
			    <input id="address_" type="text" class="form-control" placeholder="地址" value="<?php echo ($address_info["address"]); ?>">
			    <label class="control-label">是否默认</label>
			    <select id="state_" class="form-control">
			         <option value="0"  <?php if($address_info['state'] == 0): ?>selected<?php endif; ?>>否</option>
			        <option value="1" <?php if($address_info['state'] == 1): ?>selected<?php endif; ?>>是</option>
			    </select>
			    <br/>
			    <div class="btn-group btn-group-justified" role="group" aria-label="...">
			        <div class="btn-group" role="group">
			            <input id="id_" type="hidden" value="<?php echo ($address_info["address_id"]); ?>">
