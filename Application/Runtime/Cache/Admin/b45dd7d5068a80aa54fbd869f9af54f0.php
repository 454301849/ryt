...
<div class="panel panel-default">
    <div class="alert alert-success" style="padding:5px 10px;margin:15px 0;line-height:30px;">
                ...
                <div class="col-lg-2 col-md-2" style="padding:0;margin:3px;">
                    <div class="input-group input-group">
                        <span class="input-group-addon" id="sizing-addon1">开户姓名</span>
...
<script>
    ...
    function getpage(p){
        ...
        $("#list").load(
            "<?php echo U('withdraw_ajax');?>?user_name="+user_name+"&p="+p+"&type="+type+"&truename="+truename+"&start="+start+"&end="+end,
            function() {}
        );
    }
