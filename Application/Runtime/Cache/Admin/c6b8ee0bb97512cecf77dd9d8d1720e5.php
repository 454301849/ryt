            ...
            <div class="alert alert-success" style="padding:5px 10px;margin:15px 0;line-height:30px;">
                <div class="col-lg-2 col-md-2" style="padding:0;margin:3px;">
                    <div class="input-group input-group">
                        ...
                        <input type="text" class="form-control" name="user_name" id="user_name" value="<?php echo ($user_name); ?>" placeholder="输入编号查询" aria-describedby="sizing-addon1">
                    </div>
                </div>
                <div class="col-lg-2 col-md-2" style="padding:0;margin:3px;display: none">
                    <div class="input-group input-group">
                ...
                <div class="col-lg-2 col-md-2" style="padding:0;margin:3px;">
                    <div class="input-group input-group">
                        ...
                        <select class="form-control" name="type" id="type">
                            ...
                            <option value="3">领导奖</option>
                            <option value="5">分享奖</option> 
							<option value="7">区域管理奖</option>
                            <option value="8">推荐奖</option>
                        </select>
                    </div>
                </div>
...
<script>
    ...
    function getpage(p){
        ...
        $("#list").load(
            "<?php echo U('main_ajax');?>?user_name="+user_name+"&p="+p+"&type="+type+"&truename="+truename+"&start="+start+"&end="+end,
            function() {}
        );
    }
