		...
		<div>
		  ...
		  <div class="tab-content">
		    ...
		    <div role="tabpanel" class="tab-pane" id="info">
				...
				<div class="well">
					<form class="form-horizontal" action="<?php echo U('SetPassword');?>" method="post" enctype="multipart/form-data" onsubmit="return check()">
...
$(document).ready( function() {
    ...
    $('.btn-success').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('SetPassword');?>?time="+new Date(),
            dataType: "json",
            data: {
                "ypassword":ypassword,
                "password":password,
