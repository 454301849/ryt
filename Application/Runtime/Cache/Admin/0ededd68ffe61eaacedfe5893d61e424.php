     ...
     <div class="alert alert-success" style="padding:5px 10px;margin:15px 0;line-height:30px;">
                ...
                <div class="col-lg-2 col-md-2" style="padding:0;margin:3px;">
                    <div class="input-group input-group">
                        ...
                        <input type="text" class="form-control" name="truename" id="truename" placeholder="输入真实姓名查询"  value="<?php echo ($user_name); ?>"  aria-describedby="sizing-addon1">
                    </div>
                </div>
...
<script>
    ...
    function getpage(p){
        ...
        $("#list").load(
            "<?php echo U('detaillists_ajax');?>?user_name="+user_name+"&p="+p+"&type="+type+"&truename="+truename+"&start="+start+"&end="+end,
            function() {}
        );
    }
