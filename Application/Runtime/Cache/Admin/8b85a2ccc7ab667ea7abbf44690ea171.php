				...
				<div style="clear:both;"></div>
					...
					<div class="col-sm-12" style="margin: 8px 0;">
						...
						<div class="col-sm-6" style="float: right;">
							...
							<?php if($order["state"] != 2 and $order["pay_time"] != 0): ?><button type="submit" class="btn btn-primary btn-sm" id="serve_sure" style="height:35px;margin-left: 10%;margin-top: -10px;" data-loading-text="请稍候...">确认物流信息</button><?php endif; ?>
						</div>
