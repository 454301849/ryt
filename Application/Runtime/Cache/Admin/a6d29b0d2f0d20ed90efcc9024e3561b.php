					...
					<table class="table table-striped table-bordered table-hover" style="margin-top: 25px;">
						...
						<tr >
							...
							<td><div class="controls">
								<input type="text"  class="form-control"  id="username" name="username" maxlength="20" placeholder="" value="<?php echo ($user["username"]); ?>" style="width: 30%;">
							</div></td>
						</tr>
						<tr >
						...
						<tr >
							...
							<td><div class="controls">
								<input type="text"  class="form-control"  id="email" name="email" maxlength="20" placeholder="" value="<?php echo ($user["email"]); ?>" style="width: 30%;">
							</div></td>
						</tr>
							...
							<td>
								<div class="controls">
									<?php if(is_array($roles)): foreach($roles as $key=>$vo): ?><label class="checkbox inline" style="padding-left: 30px;">
											...
											<input value="<?php echo ($vo["id"]); ?>" type="checkbox" name="role_id[]" <?php echo ($role_id_checked); ?> <?php if( $vo['id'] == 1): ?>disabled="true"<?php endif; ?>><?php echo ($vo["name"]); ?>
	...
	<script type="text/javascript">
		var pck = {
			submit: function () {
				...
				var ajax = m.ajax("<?php echo U('Admin/User/edit_post');?>", null, function (jso) {
