...
class NotifyController extends Controller
{
	public function agent()
	{
		...
		switch($type)
		{
			case 1: $good_name=$daili_info[0]['first_name'];
			break;
			case 2: $good_name=$daili_info[0]['second_name'];
			break;
			case 3: $good_name=$daili_info[0]['third_name'];
			break;
			default: $good_name="未知产品";
			break;
		}
		...
		if($res)
		{
			...
			echo '<xml>' . "\xd\xa\x9\x9\x9" . '   <return_code><![CDATA[SUCCESS]]></return_code>' . "\xd\xa\x9\x9\x9" . '   <return_msg><![CDATA[OK]]></return_msg>' . "\xd\xa\x9\x9\x9" . '</xml>';
		}
	}
