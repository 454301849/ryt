...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-06-23 05:49:25
-- 服务器版本： 5.7.9
-- PHP Version: 5.6.16
...
(1, 'admin', '4c01c4dd2b5868c9c5d769eb6577039d', '', 0, '', '', 1466660560);
...
DROP TABLE IF EXISTS `wx_agent_orders`;
...
DROP TABLE IF EXISTS `wx_broke_record`;
...
DROP TABLE IF EXISTS `wx_chat_all`;
...
DROP TABLE IF EXISTS `wx_daijin`;
...
DROP TABLE IF EXISTS `wx_daili_banner`;
...
DROP TABLE IF EXISTS `wx_daili_info`;
...
DROP TABLE IF EXISTS `wx_good_pic`;
...
DROP TABLE IF EXISTS `wx_hbrecord`;
...
DROP TABLE IF EXISTS `wx_shop_ad`;
...
DROP TABLE IF EXISTS `wx_shop_bannar`;
...
DROP TABLE IF EXISTS `wx_shop_categrey`;
...
DROP TABLE IF EXISTS `wx_user_contact`;
CREATE TABLE IF NOT EXISTS `wx_user_contact` (
  ...
  `time` int(11) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户关系数据表';
...
DROP TABLE IF EXISTS `wx_ztrecord`;
